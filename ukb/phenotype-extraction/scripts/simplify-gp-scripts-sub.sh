...
#SBATCH --job-name=simp-gp-scripts
...
# srun --job-name "InteractiveJob2" --account=smed001801 --partition=veryshort --nodes=1 --ntasks-per-node=1 --cpus-per-task=1 --time=4:00:00 --mem=16GB --pty bash
